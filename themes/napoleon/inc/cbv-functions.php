...
/*  if( is_blog() && !is_front_page() ){
  ...
  if( is_front_page() || is_page_template('page-contact.php') || is_page_template('page-casino.php') || is_page_template('page-loyalty.php') || is_page_template('page-jackpots.php')){
    $class = '';
  }else{
    $class = 'page-header';
  }
